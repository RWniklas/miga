    ...
    return (
        <div className="about-container">
            ...
            <div className="about-left">
                <h2 className="about-title pb-3">
                    <i class="fa-solid fa-arrow-down" style={{ transform: "rotate(-45deg)" }}></i>
                    <b className="">Mission</b>
                </h2>
                <p className="mission-description">
                    La missione è quella di creare un’esperienza coinvolgente e multiforme che combini intrattenimento e approfondimenti culturali attraverso musica, esposizioni artistiche, attività e performance, con il costante impegno nel
                    restituire vita ai luoghi trascurati della città per trasformarli in ambienti vibranti e culturalmente arricchenti.
                </p>
            </div>
            ...
            <div className="about-right">
                ...
                <h1 className="about-title">
                    <b className="nel2021">Fondata nel 2021,</b>
                </h1>
                ...
                <p className="founded-text extra-text pt-2">
                ...
                <i class="fa-solid fa-arrow-down about-arrow"></i>
            </div>
        </div>
    );
}
